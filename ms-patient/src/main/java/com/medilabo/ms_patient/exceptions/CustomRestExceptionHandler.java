...
import com.medilabo.ms_patient.utils.CustomApiError;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNotFoundException(PatientNotFoundException ex, WebRequest request) {
        log.error("<exception> handleNotFoundException : {}", ex.getMessage());
        Map<String, String> errors = Map.of("patient", ex.getMessage());
