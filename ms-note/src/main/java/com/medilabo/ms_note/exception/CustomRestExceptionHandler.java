...
import com.medilabo.ms_note.utils.CustomApiError;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     *
     * @param ex      NoteNotFoundException
     * @param request WebRequest
     * @return ResponseEntity Object containing the error details and an HTTP status of NOT FOUND
     */
    @ExceptionHandler(NoteNotFoundException.class)
    public ResponseEntity<Object> handleNotFoundException(NoteNotFoundException ex, WebRequest request) {
        log.error("<exception> handleNotFoundException : {}", ex.getMessage());
        Map<String, String> errors = Map.of("note", ex.getMessage());
